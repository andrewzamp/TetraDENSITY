...
| File | Description |
|---|---|
| [`data/TetraDENSITY_v2.6_Database.csv`](data/TetraDENSITY_v2.6_Database.csv) | Main density records |
| [`data/TetraDENSITY_v2.6_References.csv`](data/TetraDENSITY_v2.6_References.csv) | Full bibliography |
