...
| File | Description |
|---|---|
| [`data/TetraDENSITY_v2.2_Database.csv`](data/TetraDENSITY_v2.2_Database.csv) | Main density records |
| [`data/TetraDENSITY_v2.2_References.csv`](data/TetraDENSITY_v2.2_References.csv) | Full bibliography |
