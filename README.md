...
| File | Description |
|---|---|
| [`data/TetraDENSITY_v2.3_Database.csv`](data/TetraDENSITY_v2.3_Database.csv) | Main density records |
| [`data/TetraDENSITY_v2.3_References.csv`](data/TetraDENSITY_v2.3_References.csv) | Full bibliography |
